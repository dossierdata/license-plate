...
class DutchLicensePlate extends AbstractLicensePlate implements LicensePlateInterface
{
    ...
    public function format($sidecode = 0)
    {
        ...
        switch ($sidecode) {
            ...
            case 14:
                // XXX-XX-X
                return substr($licenseplate, 0, 3) . '-' . substr($licenseplate, 3, 2) . '-' . substr($licenseplate, 5,
                        1);

            case 12:
            case 13:
                // X-XX-XXX
                return substr($licenseplate, 0, 1) . '-' . substr($licenseplate, 1, 2) . '-' . substr($licenseplate, 3,
                        3);
